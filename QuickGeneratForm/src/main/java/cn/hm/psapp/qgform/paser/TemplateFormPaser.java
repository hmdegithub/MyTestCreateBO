...
import cn.hm.psapp.qgform.paser.html.format.StandardHtmlFormatter;
import cn.hm.psapp.qgform.util.IOUtils;

public class TemplateFormPaser implements FormPaser {

  private String templateFilePath;
  private BytesFindProcesser replaceProcesser = new BMBytesFindProcesser();
  private FieldHtmlFormatter parser = new StandardHtmlFormatter();

  public TemplateFormPaser(String templateFilePath) {
